...
if test -f ${DESTDIR}/home/sh/httpd-2.4.49-trace/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/home/sh/httpd-2.4.49-trace/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/home/sh/httpd-2.4.49-trace/bin/apu-1-config
else
...
test -n "/home/sh/httpd-2.4.49-trace/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/home/sh/httpd-2.4.49-trace/build"
